...
export default class App extends Component {
    ...
    return this.state.quotes.map((item, index) => {
      return (
        <li className="list-group-item" key={item}>
          {item}
          <button onClick={this.onRemoveClick.bind(this, item)} className="btn btn-danger">Remove</button>
        </li>
      );
    });
  }
  ...
  render() {
    ...
    return (
      <div>
        <button onClick={this.onAddClick.bind(this)} className="btn btn-success">Add</button>
